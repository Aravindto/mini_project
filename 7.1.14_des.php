    ...
    <body style=" background:url('images/mount.jpg') no-repeat;
	  ...
	  <div class="container">
            <div id="form-main">
                <div id="form-div">
                    <center>
                      <h3><strong style="color:white">7.1.14 - Programs above national identities</strong></h3></center>
             <form name="qm7.1.14" id="7.1.14" action="7.1.14_rep.php" method="post" class="montform">
	  ...
	  <?php 
             ...
             $plno_no = (isset($_POST["plno"])? $_POST["plno"] : '');
                $sq = "select * from plans where plno = '$plno_no'";
                 $result = mysql_query($sq);
                
                while($rec = mysql_fetch_array($result))
                    {
					?>
					<tr><td><label>plno</label></td>
					<td><input type="text" name="plno" readonly value="<?php echo $rec['plno'];?>" /></td></tr>
			 ...
			 <td><input type="text" name="qm_index" placeholder="Quantitative Metrics Index" value="QM-7.1.14" readonly></td></tr>
			 ...
			 <option value="2012-2013">2029-2030</option>
			  ...
			  <tr><td><label>Title of the Programme/Activity</label></td>
			 <td><input type="text" name="act" placeholder="" value="<?php echo $rec['prog'];?>" ></td></tr>
			 ...
			 <tr><td><label>Number of participants </label></td>
			 <td><input type="text" name="part" placeholder="" value="<?php echo $rec['num'];?>"></td></tr>
			 	 			  <br><br>
...
else 
{
         ?>  
			<tr><td width="331"><label>Criteria index</label></td>
			 <td width="137"><input type="text" name="cr_index" placeholder="Criteria index" value="CR007" readonly></td></tr>
			 <tr><td><label>Key Indicator</label></td>
			 <td><input type="text" name="ki_index" placeholder="Key Indicator" value="KI7.1" readonly></td></tr>
			 <tr><td><label>Quantitative Metrics Index</label></td>
			 <td><input type="text" name="qm_index" placeholder="quantitative metrics index" value="QM7.1.4" readonly></td></tr>
			 <tr><td><label>Year</label></td>
			 <td><select name="year" >
			 <option value="2012-2013">2012-2013</option>
			 <option value="2013-2014">2013-2014</option>
			 ...
			 <option value="2012-2013">2029-2030</option>
			  ...
			  <tr><td><label>Title of the Programme/Activity</label></td>
			 <td><input type="text" name="act" placeholder=""></td></tr>
			  <tr><td><label>From</label></td>
