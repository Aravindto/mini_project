    ...
    <body style=" background:url('images/mount.jpg') no-repeat;
	  ...
	  <div class="container">
            <div id="form-main">
                <div id="form-div">
                    <center>
                      <h3><strong style="color:white">7.1.17 - Promotion of Universal values</strong></h3></center>
             <form name="qm7.1.17" id="7.1.17" action="7.1.17_rep.php" method="post" class="montform">
	  ...
	  <?php 
             ...
             $pmno_no = (isset($_POST["pmno"])? $_POST["pmno"] : '');
                $sq = "select * from promotion where pmno = '$pmno_no'";
                 $result = mysql_query($sq);
                
                while($rec = mysql_fetch_array($result))
                    {
					?>
					<tr><td><label>pmno</label></td>
					<td><input type="text" name="pmno" readonly value="<?php echo $rec['pmno'];?>" /></td></tr>
			 ...
			 <td><input type="text" name="qm_index" placeholder="Quantitative Metrics Index" value="QM-7.1.17" readonly></td></tr>
			 ...
			 <td><input type="text" name="act" placeholder="" value="<?php echo $rec['activity'];?>" ></td></tr>
